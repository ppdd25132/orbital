...
export default function SnoozeMenu({ onSnooze, onClose }) {
  ...
  return (
    <div
      ref={menuRef}
      className="absolute right-0 top-11 z-50 w-56 rounded-xl border border-[#2a2d38] bg-[#151821] py-1.5 shadow-2xl anim-scale"
    >
      ...
      <div className="mx-3 mt-1 border-t border-[#1e2028] pt-1">
        {!showCustom ? (
          <button
            ...
            className="flex w-full items-center gap-2 py-2.5 text-[13px] text-[#7a7f8e] transition-colors hover:text-[#c8ccd4]"
          >
